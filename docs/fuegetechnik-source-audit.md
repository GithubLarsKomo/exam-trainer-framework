...
| `ft2101` | 21 | S. 113, 5.7.1 Mechanisch-technologische Verfahren | Source page assigned for the runtime statement |
...
2. Q16 — exact current-source evidence for the power-source characteristic and the two arc types expected in the drawing.
3. Q19/Q21 — verify the intended heat-affected-zone subdivisions and wording of the mechanical-technological test question.
4. Q24/Q27 — verify the exact source scope of carbon-content effects and cold-cracking statements.
5. Q30–Q45 — finish exact page/section mapping, then leave only genuinely asset-dependent warnings open.
